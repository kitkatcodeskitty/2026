  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      <div className="flex items-center my-5 gap-2">
        ...
        <h1 className="font-bold text-neutral-700">Comments({comment.length})</h1>
      </div>
      ...
      <div className="space-y-5 ">
        {
            comment.map((items)=>{
              return(
                <div key={items.id} className="border border-neutral-400 p-5 rounded-2xl  hover:shadow-sm">
